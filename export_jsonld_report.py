def map_hierarchy(concept_id):
    ...
    if 'payable' in c or c == 'section:current-liabilities' or c == 'section:non-current-liabilities': return "section:total-liabilities"
    ...
    if 'expense' in c: return "section:profit-loss"
